...
First thing, I started with the pcap. It had 22 packets over loop-able 31337 port and not all of them carried data. Using `tcp.len > 0`, they left me with 11 packets carrying actual payloads.
