...
![Copy the file to run directory](/truth/jtr-run-pdf.png)
...
![Extracting the password hash from the PDF file using pdf2john.pl](/truth/jtr-hash.png)
...
![John the Ripper successfully cracking the PDF password](/truth/jtr-cracked.png)
