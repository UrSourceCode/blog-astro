...
categories: ["CTF", "Reverse Engineering", "Forensics", "Cryptography"]
---
...
Since I already knew that there are 8 packets with messages, using my best friend [ChatGPT](https://chatgpt.com/), I generated a script to pull the payloads from the pcap:
